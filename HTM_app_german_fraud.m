...
%% INPUT: data:
%% To run a sample uncomment the one of Interest
data_name = 'german_data_'; %Note 50 samples
%data_name = 'german_data_50'; %Note 50 samples
%data_name = 'german_data_100'; %Note 100 samples
%data_name = 'german_data_150'; %Note 150 samples
%data_name = 'german_data_200'; %Note 200 samples
%data_name = 'german_data_250'; %Note 250 samples
%data_name = 'german_data_300'; %Note 300 samples
k = 50*(menu('Select input data sample size','50','100','150','200','250','300'));
%% HTM-SP PARAMETERS:
iters = 5;% Values: 5,10,30,100,1000 (depend on computational capacity)
initPerm = 0.21; %Initial Permanence
connectedPerm_ = 0.81; % Permanence threshold (Key - improper setting may cause error)
...
w = 15; % sdr vector number of ON bits (Key - improper setting may cause error)
...
%% Data Handling:
data_name_n =  [data_name num2str(k) '.' 'txt'];
